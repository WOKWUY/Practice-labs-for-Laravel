...
<head>
   ...
   <!-- css definition file -->
        ...
        <div class="row">
            ...
            <div class="lblinput">
                <select name="khuvuc">
                    ...
                    <option value="2" <?php echo $_POST['area']==2 ? "selected":"" ?>> Area 1 </option>
                    <option value="3" <?php echo $_POST['area']==3 ? "selected":"" ?>> Area 1 </option>
                    <option value="4" <?php echo $_POST['area']==4 ? "selected":"" ?>> Area 1 </option>
                    <option value="5" <?php echo $_POST['area']==5 ? "selected":"" ?>> Area 1 </option>
                </select>
            </div>
        </div>
    ...
    <div class="row">
        ...
        if(isset($_POST['btnsubmit'])){$totalpoints = $_POST['math'] + $_POST['physics'] + $_POST['chemistry'];
